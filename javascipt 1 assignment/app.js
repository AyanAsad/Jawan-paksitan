...
// alert("first name: ayan");
// alert("last name : khan");
// alert("Email: ayan47816@gmail.com");
// alert("Phone Number: 03546787856");
// alert("Password: secret123");
...
// var firstNameLastName = "AyanKhan"; 
...
// //  Code a prompt with the message "Country?" and the default answer "China". The user's response is assigned to country.
...
// var userResponse = prompt("Enter your favorite color", "Blue");


// //  Assign strings to two variables. Code a prompt specifying the first variable as the message and the second variable as the default response. Assign the user's response to a third variable.


// var message = "Enter your hometown";
// var defaultResponse = "Bufferzone";
// var userHometown = prompt(message, defaultResponse);

// //  Display a prompt, including both a message and a default response. Display the user's response in an alert.



// var userInput = prompt("Enter your age", "14");
...
// var isl= +prompt("enter your islamiyat Mark");
// // var urdu= +prompt("enter your urdu Mark");
// var obtainMarks = Eng + math + isl + urdu
// var total = 400
// // var perc=(obtainMarks/total)*100
// if (perc >= 80 && perc <= 100) {
...
//    ___var a = 5; // Yahan `a` ki value set kar rahe hain. Aap isse change kar sakte hain.
...
// var d = 25; 
// if (a === b || c !== d) {
//     alert("Either a equals b or c does not equal d.");
// } else {
...
// if ((name === "Ayan" || name === "Arsalan") && age < 60) {
//     alert("Name is either Hamza or Arsalan, and age is less than 60.");
// } else {
...
//     alert("Your first and last name match the stored values!");
// } else {
//     alert("Your names do not match the stored values.");
// }
...
// var arrayWithOneElement = ["First"];
// arrayWithOneElement[1] = "Second";
